...
/*          printf("tmp_rwcf[%1d] = %5.2lf  ", ilyr, tmp_rwcf[ilyr]); */
          rwcf[clyr] += tmp_rwcf[ilyr]*layers->width[ilyr];
          tdepth += layers->width[ilyr];
        }
        rwcf[clyr] /= tdepth; 
/*        printf("\nrwcf[%1d] = %5.2lf\n", clyr, rwcf[clyr]); */
        rwcf[clyr] = max(rwcf[clyr], 0.0);
      }
      ...
      avh2o[0] = 0.0;  /* avh2o(1): 0 to 30 cm */
      avh2o[1] = 0.0;  /* avh2o(2): 1..nlayer */
      avh2o[2] = 0.0;  /* avh2o(3): 1, 2 */
