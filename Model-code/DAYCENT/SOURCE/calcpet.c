...
#include <stdio.h>
    ...
    void calcpet(int *jday, int *month, double *tmin, double *tmax, double *tavg,
                 double *solrad, double *rhumid, double *windsp, double *snow,
                 int *usexdrvrs, double fwloss[4], double *sitlat,
                 double tmn2m[], double tmx2m[], double *petdly)
    {
