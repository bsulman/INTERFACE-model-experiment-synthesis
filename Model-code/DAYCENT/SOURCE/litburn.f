...
c ... Argument declarations
      double precision litrme(MAXIEL)
...
c ... Local variables
      integer  iel
      double precision stremc,streme(MAXIEL),metrmc,metrme(MAXIEL) 
      double precision som1rmc,som1rme(MAXIEL),som2rmc,som2rme(MAXIEL) 
