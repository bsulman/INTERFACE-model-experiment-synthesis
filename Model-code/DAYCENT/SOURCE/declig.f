...
c ... Argument declarations
      ...
      double precision aminrl(MAXIEL), ligcon, ps1co2(2), 
     &          rnew(MAXIEL,2), rsplig, tcflow, tcstva(nlr), 
     &          csrsnk(ISOS), cstatv(nlr,ISOS), elstva(nlr,MAXIEL), 
     &          gromin(MAXIEL), minerl(MAXLYR,MAXIEL), 
     &          netmnr(nlr,MAXIEL),resp(ISOS), som1ci(2,ISOS),
     &          som1e(2,MAXIEL), som2ci(2,ISOS), som2e(2,MAXIEL)
      double precision cflowtosom1,cflowtosom2
...
c ... Local variables
      ...
      double precision accum(ISOS), co2los, mnrflo, tosom1, tosom2,
     &          rnew1(MAXIEL)
