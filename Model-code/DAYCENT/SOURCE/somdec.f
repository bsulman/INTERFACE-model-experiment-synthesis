...
C ... SOMDEC.F
      ...
      subroutine somdec(amovdly, dtm, t1, t2, newminrl, rpeff, soilsrad)
...
c ... Argument declarations
      ...
      double precision dtm, rpeff, soilsrad
...
c ..... Compute pH effect on decomposition
        ...
        call rateconv(rateDay, rate2, t1, t2)
c       tcflow = som2c(SOIL) * bgdefac * rate2 * 
c    &           cltfac(2) * anerb * pheff
c ..... Add the root priming effect for a variable som2c(SOIL)
c ..... decomposition rate, CAK - 01/28/2014, MDH - 05/02/2016
        tcflow = som2c(SOIL) * bgdefac * rate2 * 
     &           cltfac(2) * anerb * pheff * * rpeff
c ..... where
