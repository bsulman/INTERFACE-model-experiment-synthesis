...
/*            pl[indx] = 2.8 * exp(-0.805 * (ii+1)); */
            pl[indx] = 1.4 * exp(-0.805 * (ii+1));
/*            pl[indx] = 1.2 * exp(-0.805 * (ii+1)); */
          }
          pflag = 2;
...
/*            pm[indx] = 3.67 * exp(-0.384 * (ii+1)); */
            pm[indx] = 1.835 * exp(-0.384 * (ii+1));
/*            pm[indx] = 1.3 * exp(-0.384 * (ii+1)); */
          }
          pflag = 6;
        } else {
...
/*            ph[indx] = 4.615 * exp(-0.208 * (ii+1)); */
            ph[indx] = 2.3075 * exp(-0.208 * (ii+1));
/*            ph[indx] = 1.5 * exp(-0.208 * (ii+1)); */
          }
          pflag = 13;
        }
